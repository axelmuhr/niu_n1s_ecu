...
I did a much more intense disassembly using Ghidira identifying mostly all functions in the code and tried to document them as good as possible.
See the **doc** folder for indepth analysis.
